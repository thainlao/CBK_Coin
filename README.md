...
---
## Функционал
### автоматическая авторизация пользователь только внутри телеграмма, для каждого пользователя свои задания, отслеживание их выполнений, безопасность, статистика и тд. 
---
